...
const ViewAllFlight = () => {
  ...
  const retrieveAllScheduledFlights = async () => {
    ...
    // Normalizar respuesta: puede venir como { flights: [...] } o como un array [...]
    console.log("retrieveAllScheduledFlights response:", response.data);
    return response.data;
  };
  ...
  const searchScheduledFlightsByUserInput = async () => {
    ...
    console.log("searchScheduledFlightsByUserInput response:", response.data);
    return response.data;
  };
      ...
      if (
        ...
        if (flights) {
          ...
          const list =
            ...
            (Array.isArray(flights) ? flights : null);

          if (list && Array.isArray(list)) {
            setScheduledFlights(list);
          } else {
            console.warn("searchScheduledFlightsByUserInput: estructura inesperada:", flights);
            setScheduledFlights([]);
          }
        }
      } else {
        ...
        if (flights) {
          ...
          if (list && Array.isArray(list)) {
            ...
            console.warn("retrieveAllScheduledFlights: estructura inesperada:", flights);
            setScheduledFlights([]);
          }
        }
      }
            ...
            <div className="col">
              <form className="row g-3 align-items-center">
                ...
                <div className="col-auto">
                  <button
                    type="submit"
                    className="btn bg-color custom-bg-text btn-lg"
            ...
            <table className="table table-hover text-color text-center">
              <thead className="table-bordered border-color bg-color custom-bg-text">
                <tr>
                  ...
                  <th scope="col">Economy Fare (US.)</th>
                  <th scope="col">Business Fare (US.)</th>
                  <th scope="col">First Class Fare (US.)</th>
              ...
              <tbody>
                {scheduledFlights.map((flight) => {
                  return (
                    <tr key={flight.id ? flight.id : flight.flightNumber}>
                      <td>
